...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-_kur06-$n*zu0+hw7u#)doz_3@w5k4*#zqo-aqlmb1q&0kdmkh')

# SECURITY WARNING: don't run with debug turned on in production!
# Read DEBUG from env (1/0 or true/false)
